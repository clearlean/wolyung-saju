...
export const CONSENT_COPY = {
  ...
  sections: [
    {
      heading: '수집하는 항목',
      body: '이름, 생년월일, 태어난 시간, 성별, 재학중인 대학교, 학과, 인스타그램 아이디',
    },
    {
      heading: '이용 목적',
      body: '사주 기반 연애운 풀이 제공, 사주를 활용한 소개팅 상대 매칭',
    },
    {
      heading: '제3자 제공',
      body: '매칭이 성사되면 상대방에게 회원님의 인스타그램 아이디와 재학중인 대학교, 학과가 공개됩니다. 이름, 생년월일, 태어난 시간은 상대방에게 제공하지 않습니다.',
    },
    {
      heading: '보유 및 이용 기간',
      body: '매칭 종료 후 6개월간 보관한 뒤 파기합니다. 그 전에도 삭제를 요청하시면 지체 없이 파기합니다.',
    },
    {
      heading: '동의를 거부할 권리',
